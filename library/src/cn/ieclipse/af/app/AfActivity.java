...
public abstract class AfActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        windowBgColor = getResources().getColor(android.R.color.transparent);
        // 1, init intent
    ...
    public boolean isShowTitleBar() {
        return showTitleBar || (mTitleBar != null
    ...
    public void setShowTitleBar(boolean showTitleBar) {
        if (this.showTitleBar != showTitleBar) {
            ...
            if (mTitleBar != null) {
                mTitleBar
                        .setVisibility(showTitleBar ? View.VISIBLE : View.GONE);
            }
            if (mContentView != null) {
                RelativeLayout.LayoutParams lp = (android.widget.RelativeLayout.LayoutParams) mContentView
                        .getLayoutParams();
    ...
    public void setWindowBackground(int colorId) {
        if (colorId > 0) {
            this.windowBgColor = getResources().getColor(colorId);
        }
    }
...
//            }
        ...
        if (rootLayoutId > 0) {
            ...
            // mContentView.addView(mLayoutInflater.inflate(rootLayoutId,
            // mContentView, false), new LayoutParams
            // (LayoutParams
            // .MATCH_PARENT,
    ...
    private void setContentViewLayoutParams(RelativeLayout.LayoutParams lp,
            boolean overlay, boolean showTitleBar) {
        if (lp != null) {
